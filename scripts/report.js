...
Events.on(EventType.ClientLoadEvent, () => {
	...
	remind.cont.pane(table => {
		...
		table.button("QQ交流群", run(() => {
			Core.app.openURI("https://qun.qq.com/universal-share/share?ac=1&authKey=4AZDxZH1JSLU7pPJhQ1fTkjszA2HZzo75C4B1j2mkS6QOEqRMYnpSGH2QWQlP%2BTu&busi_data=eyJncm91cENvZGUiOiIxMDczNTA2NTIyIiwidG9rZW4iOiJyMWQxQTJnZGFQNHZEVUkzb0JjLzI4RXJqU01taFlwOFByQWU3TzEyQWx0SnBxTWpsYW1PWm8wWjZDVEpiMVRNIiwidWluIjoiMzM1MDgyNTIzNyJ9&data=JqQlKFk8rUfWj69NYEyFGyhArXInc52ooqwooZljLcUJsBn8C1rnI3CHypNbmaRWnrWGHdclarLOaWXGVIlZMQ&svctype=4&tempid=h5_group_info");
		})).size(200,64).pad(4).row();
