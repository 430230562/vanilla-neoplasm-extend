...
laboratory.buildType = prov(() => extend(UnitFactory.UnitFactoryBuild, laboratory, {
    ...
    onDestroyed() {
        Damage.damage(this.x, this.y, 72, 800);
...
const geneForgeAlpha = new UnitAssembler("gene-forge-alpha");
exports.geneForgeAlpha = geneForgeAlpha;
Object.assign(geneForgeAlpha, {
    size: 5,
    areaSize: 13,
    plans: Seq.with(
